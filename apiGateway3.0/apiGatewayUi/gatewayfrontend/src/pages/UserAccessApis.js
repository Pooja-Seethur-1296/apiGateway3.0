...
//         userId: user.userId,
//         apiKey: selectedEndpoint.endPointToken,
//         url: selectedEndpoint.endPoint,
//       };

//       if (!["GET", "DELETE"].includes(method)) {
//         options.requestBody = body || null;
//       }

//       // console.log(JSON.stringify(options));
//       const res = await reRoute(options);
    ...
    <Box sx={{ p: 4, maxWidth: 1000, mx: "auto" }}>
      ...
      {selectedEndpoint && (
        ...
        >
          ...
          <Chip label="application/json" size="small" variant="outlined" />
        </Box>
      )}
